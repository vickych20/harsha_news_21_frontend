            ...
            <div className='py-2 px-4 w-[100%] mt-5'>
                <div className="flex justify-between w-full">
                    ...
                    <div className="bg-green-300 cursor-pointer flex flex-row items-center rounded-lg px-3 py-2">
                        ...
                        <button className='border-none text-lg font-bold p-0 m-0'>Upload New Audio</button>
                    </div>
                </div>
                    ...
                    <table className='bg-white w-[100%]'>
                        <thead>
                            <tr>
                                ...
                                <th className='px-3 py-2 border'>Audio File</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className='border px-4 py-2'>hello_song.mp3</td>
